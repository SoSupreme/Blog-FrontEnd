...
export const changePasswordInput = createAction(CHANGE_PASSWORD);
...
export default handleActions({
    [SHOW_MODAL]: (state,action) => {
        const { payload: modalName } = action;          // modalName : remove나, login 이 됨
    ...
    ...pender({
        type: LOGIN,
        onSuccess: (state,action) => {      // Login succes
